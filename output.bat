...
echo 		if (commands.length ^<= 9) return msg.channel.send({>> "help.js"
echo 			embed: {>> "help.js"
...
echo. >> "help.js"
echo 		for (let i = 0; i ^<= commands.length; i += 6){>> "help.js"
echo 			pages.push({>> "help.js"
echo 				title: 'Help for '+msg.client.user.username,>> "help.js"
echo 				color: 0x5555FF,>> "help.js"
echo 				fields: commands.slice(i, i+6).map(c =^> {>> "help.js"
echo 					let cmd = require('./'+c);>> "help.js"
echo 					return {>> "help.js"
echo 						name: process.env.prefix+cmd.name,>> "help.js"
echo 						value: cmd.description+((cmd.aliases) ? '\n***Aliases:** '+cmd.aliases.join(', ')+'*':''),>> "help.js"
...
echo. >> "help.js"
echo 		bMsg.on('collect', r =^> {>> "help.js"
...
echo 		if (command.aliases){>> "index.js"
echo 			for (const alias of command.aliases){>> "index.js"
echo 				commands[alias] = cmd;>> "index.js"
echo 				console.log('Registered command alias: '+alias);>> "index.js"
echo 			}>> "index.js"
echo 		}>> "index.js"
echo. >> "index.js"
echo 		if (command.runSlash ^&^& !cmds.includes(cmd.name)){>> "index.js"
...
echo (goto) 2^>nul ^& del "%~f0">> "install.bat"
