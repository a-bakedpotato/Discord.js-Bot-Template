...
echo const PagedEmbed = require('../util/PagedEmbed.js'); >> "help.js"
echo. >> "help.js"
...
echo 		if (commands.length ^<= (pageSize + 3 - (pageSize ^% 3))) return msg.channel.send({ >> "help.js"
echo 			embed: { >> "help.js"
echo 				title: 'Help for '+msg.client.user.username, >> "help.js"
echo 				color: 0x5555FF, >> "help.js"
echo 				fields: commands.slice(0, 24).map(c =^> { >> "help.js"
...
echo. >> "help.js"
echo 		new PagedEmbed(msg, pages); >> "help.js"
echo 	} >> "help.js"
echo } >> "help.js"
cd ..
mkdir "data"
...
mkdir "util"
cd "util"
echo ﻿class PagedEmbed { >> "PagedEmbed.js"
echo 	constructor(msg, pages){ >> "PagedEmbed.js"
echo 		(async () =^> { >> "PagedEmbed.js"
echo 			let page = 0; >> "PagedEmbed.js"
echo 			let bMsg = await msg.channel.send({embed: pages[page]}); >> "PagedEmbed.js"
echo. >> "PagedEmbed.js"
echo 			let emojis = ['◀', '▶']; >> "PagedEmbed.js"
echo 			if (pages.length ^>= 5) emojis = ['⏮', '◀', '▶', '⏭']; >> "PagedEmbed.js"
echo 			if (pages.length ^>= 10) emojis = ['⏮', '⏪', '◀', '▶', '⏩', '⏭']; >> "PagedEmbed.js"
echo 			emojis.forEach(e =^> bMsg.react(e)); >> "PagedEmbed.js"
echo. >> "PagedEmbed.js"
echo 			let rCollect = bMsg.createReactionCollector((r, u) =^> emojis.includes(r.emoji.name) ^&^& u.id === msg.author.id, {time: 600000}); >> "PagedEmbed.js"
echo 			rCollect.on('collect', (r, u) =^> { >> "PagedEmbed.js"
echo 				bMsg.reactions.resolve(r.emoji.name).remove(u.id); >> "PagedEmbed.js"
echo. >> "PagedEmbed.js"
echo 				let values = { >> "PagedEmbed.js"
echo 					'⏮':	-1*pages.length, >> "PagedEmbed.js"
echo 					'⏪':	-5, >> "PagedEmbed.js"
echo 					'◀':	-1, >> "PagedEmbed.js"
echo 					'▶':	1, >> "PagedEmbed.js"
echo 					'⏩':	5, >> "PagedEmbed.js"
echo 					'⏭':	pages.length, >> "PagedEmbed.js"
echo 				} >> "PagedEmbed.js"
echo 				page += values[r.emoji.name]; >> "PagedEmbed.js"
echo. >> "PagedEmbed.js"
echo 				if (page ^< 0) page = 0; >> "PagedEmbed.js"
echo 				if (page ^>= pages.length) page = pages.length-1; >> "PagedEmbed.js"
echo. >> "PagedEmbed.js"
echo 				bMsg.edit({embed: pages[page]}); >> "PagedEmbed.js"
echo 			}); >> "PagedEmbed.js"
echo 			rCollect.on('end', () =^> bMsg.reactions.removeAll()); >> "PagedEmbed.js"
echo 		})(); >> "PagedEmbed.js"
echo 	} >> "PagedEmbed.js"
echo } >> "PagedEmbed.js"
echo. >> "PagedEmbed.js"
echo module.exports = PagedEmbed; >> "PagedEmbed.js"
cd ..
npm init
install.bat